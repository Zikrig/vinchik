...
- Админка бота `/admin`: заявки Премиум, премиум-юзеры, soft-launch, настройки (те же поля, что в веб: лимит, радиус, повтор, карта, время проверки, менеджер). Баны — веб `:8180`.
